...
public class InsertResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            //フォームの生年月日をそれぞれint型に変換
            int y=Integer.parseInt((String)udb.getYear());
            int m=Integer.parseInt((String)udb.getMonth());
            int d=Integer.parseInt((String)udb.getDay());
            ...
            userdata.setComment((String)udb.getCom());
