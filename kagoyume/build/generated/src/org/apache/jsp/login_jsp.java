...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    UserDataDTO udd=new UserDataDTO();
      ...
      out.write("    <body>\n");
      out.write("        ");
 if(request.getAttribute("err").equals("nodata")){ 
      out.write("\n");
      out.write("        ログインに失敗しました。<br>\n");
      out.write("        ");
 }else if(udd.getDeleteFlg()==1){ 
      out.write("\n");
      out.write("        このアカウントは削除されています。\n");
      out.write("        ");
 } 
      out.write("\n");
      out.write("        <form action=\"loginchk\" method=\"post\">\n");
      out.write("            メールアドレス： <input type=\"text\" name=\"mail\"><br>\n");
      ...
      out.print( hs.getAttribute("ac"));
      out.write("\">\n");
      out.write("            <input type=\"submit\" value=\"会員登録はこちら\">\n");
      out.write("        </form>\n");
      out.write("        <a href=\"top.jsp\">トップに戻る</a>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
