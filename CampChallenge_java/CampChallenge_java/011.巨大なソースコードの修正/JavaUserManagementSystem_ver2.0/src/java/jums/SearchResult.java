...
public class SearchResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(request.getParameter("name")!=null){ //戻るボタンで戻ってきたときはこの処理をスルー
            ...
            ArrayList<UserDataDTO> resultData = UserDataDAO.getInstance().search(udd);
            udd.setResultList(resultData);
