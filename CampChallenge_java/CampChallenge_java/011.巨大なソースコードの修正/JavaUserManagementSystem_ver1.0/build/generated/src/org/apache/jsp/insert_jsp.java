...
public final class insert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    HttpSession hs = request.getSession();
      ...
      out.write('\n');
      out.write('\n');
      jums.UserDataBeans user = null;
      synchronized (_jspx_page_context) {
        user = (jums.UserDataBeans) _jspx_page_context.getAttribute("user", PageContext.PAGE_SCOPE);
        if (user == null){
          user = new jums.UserDataBeans();
      ...
      out.write(org.apache.jasper.runtime.JspRuntimeLibrary.toString((((jums.UserDataBeans)_jspx_page_context.findAttribute("user")).getName())));
      out.write("\">\n");
      out.write("        <br><br>\n");
      out.write("\n");
      out.write("        生年月日:　\n");
