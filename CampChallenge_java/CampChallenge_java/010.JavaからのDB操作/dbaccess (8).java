...
public class dbaccess extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form method=\"post\" action=\"dbaccess\">");
            out.println("<input type=\"search\" name=\"sample\">");
            ...
            try{
                ...
                String search=request.getParameter("sample");
                String sql="SELECT * FROM profiles where name like '%"+search+"%';";
